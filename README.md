...
| Aim of LunarDAO launch raise size (minimum, aim, maximum):  | 666 ETH, 6666 ETH, 15000 ETH (if hit, the smart contract expires).                                                                                                                                                                                                                                                                                                            | *As Portfolio*                                                                                                                                                                                                                                                                        |
...
2. What amount does the DAO aim to raise (the first round)? - the proposed mark is 6666 ETH (666 minimum and 15000 cap).
